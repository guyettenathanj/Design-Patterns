...
I'm building a [meta programming framework](https://github.com/guyettenathanj/Easy-CSharp-Metaprogramming) in C# to help ameliorate some of the overhead of having to type the same thing over and over again.
